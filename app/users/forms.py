...
class ModifyInformationForm(FlaskForm):
    ...
    oldPassword = PasswordField('Password', validators=[Length(min=8)], render_kw={'placeholder': 'Insert your old password'})
    newPassword = PasswordField('Password', validators=[Length(min=8)], render_kw={'placeholder': 'Insert your new password'})
    confirmNewPassword = PasswordField('Password', validators=[Length(min=8)],
