...
class SignUpForm(FlaskForm):
    firstName = StringField('First Name', validators=[DataRequired(message='You need to insert your firstname')], render_kw={'placeholder': 'Your firstname'})
    ...
    confirmPassword = PasswordField('Confirm password', validators=[DataRequired(message='You need to confirm your password'), Length(min=8), EqualTo('password')], render_kw={'placeholder': 'Confirm your password'})
    ...
    user_or_owner = RadioField('Select your profile type', validators=[DataRequired(message='You need to select your profile type')], choices=[('user', 'User'), ('owner', 'Owner')])
